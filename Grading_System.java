...
public class Grading_System extends JFrame {
    ...
    public Grading_System() {
        ...
        addButton.setBounds(538, 389, 90, 46);
        panel.add(addButton);
        ...
        updateButton.setBounds(437, 624, 90, 49);
        ...
        deleteButton.setBounds(592, 624, 90, 49);
        ...
        clearButton.setBounds(654, 389, 90, 46);
        ...
        exitButton.setBounds(737, 624, 90, 49);
        panel.add(exitButton);

        JScrollPane scrollPane = new JScrollPane();
        scrollPane.setBounds(10, 463, 1242, 150);
        ...
        lblNewLabel.setBounds(403, 19, 536, 68);
